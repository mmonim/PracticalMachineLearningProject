...
Mohamed Ali [GitHub](https://github.com/mmonim/PracticalMachineLearningProject)  


```
## Run time: 2016-11-12 11:02:13
## R version: R version 3.2.3 
```
...
```r
seed <- as.numeric(as.Date("2016-11-12"))
set.seed(seed)
